    ...
    <section class="bg-cover bg-center h-[500px] lg:h-[600px] w-full text-[#1E293B]"
        ...
        <div class="max-w-[1200px] w-[90%] h-full xl:w-full m-auto text-white grid lg:grid-cols-2 items-center">
            <div>
                ...
                <p data-aos="fade-right" data-aos-duration="2000" data-aos-delay="500">Kami percaya, rumah bukan sekadar bangunan, tetapi tempat tumbuh dan berproses. Karena itu, kami tidak
                    hanya
    ...
    <section>
        <div
            ...
            <div class="order-2 md:order-1">
                ...
                <br>
                <p class="text-justify" data-aos="fade-right" data-aos-duration="2000">Dengan pengalaman dan tim profesional di bidang konstruksi, kami melayani berbagai
        ...
        <div class="max-w-[1200px] w-[90%] xl:w-full m-auto text-[#1E293B]">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                <div class="bg-white rounded-xl border border-gray-300 h-full" data-aos="fade-right" data-aos-duration="2000">
                    ...
                    <div class="p-5">
                        <div class="mb-5">
                            <h3 class="font-bold text-center text-lg">Thahirudin</h3>
                            <p class="text-center font-semibold">CEO</p>
                        </div>
